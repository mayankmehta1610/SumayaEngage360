        ...
        children: [
          if (error != null)
            Padding(
                ...
                child: Text(error!,
                    style: const TextStyle(color: E360Theme.danger))),
          ...
          if (b != null && AuthService.isOps) ...[
            ...
            _grid([
              ...
              KpiTile('${b['shortlisted']}', 'Shortlisted',
                  color: E360Theme.success),
              KpiTile('${b['employeesTotal']}', 'Employees'),
              KpiTile('${b['onboardingOpen']}', 'Onboarding',
                  color: E360Theme.warning),
              KpiTile('${b['timesheetsSubmitted']}', 'Timesheets pending',
                  color: E360Theme.warning),
              KpiTile('${b['exitsInFlight']}', 'Exits in progress',
                  color: E360Theme.warning),
            ]),
            Card(
              child: Padding(
                ...
                child: Column(
                    ...
                    children: [
                      const Text('Applications by stage',
                          style: TextStyle(fontWeight: FontWeight.w700)),
                      const SizedBox(height: 10),
                      ...((b['applicationsByStatus'] as List?) ?? []).map((s) =>
                          _bar(
                              context,
                              s['status'].toString(),
          ...
          if (p != null) ...[
            ...
            _grid([
              ...
              KpiTile('${p['trainingsToComplete']}', 'Trainings due',
                  color: E360Theme.warning),
              KpiTile(
                  '${p['appraisalsAwaitingSelfReview']}', 'Self-reviews due',
                  color: E360Theme.warning),
              KpiTile('${p['recognitionsReceived']}', 'Recognitions',
                  color: E360Theme.success),
            ]),
              ...
              Card(
                child: ListTile(
                  leading: const Icon(Icons.pending_actions,
                      color: E360Theme.warning),
                  title: Text(
                      '${k!['myApprovals']} item(s) waiting for YOUR approval',
